...
class ChequeScreen(BaseScreen):
    def __init__(self, page):
        ...
        cheque_details = [ self.company_name, self.branch_name, self.address, self.inn_label, self.inn_value,
        ...
        def check_cheque_details_for_purchasing(cheque_details):
            all_items = len(cheque_details)
